...
|---|---|
| Reproductibilité 10⁻⁹, aucune méthode approchée | **Double précision binaire, et elle est ici indispensable** — pas pour l'exactitude du résultat métier, mais parce que la tolérance de 10⁻⁹ entre deux implémentations ne tient pas en simple précision. Contraste avec [SPEC-MAS-001](../mass-balance/2-SPEC-MAS-001.en.md), où c'est la conservation exacte de la masse qui imposait un décimal exact : **trois exigences différentes, trois types numériques différents** |
