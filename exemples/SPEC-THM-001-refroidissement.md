...
| Justesse 10⁻⁶ relatif, validité du modèle ± 2 °C | **La double précision binaire suffit très largement.** Contraste voulu avec [SPEC-MAS-001](bilan-de-masse/2-SPEC-MAS-001-batch-mass-balance.md), où la conservation exacte de la masse imposait un décimal exact : ici, la grandeur physique est elle-même incertaine à 2 °C près. **La même méthode, appliquée à deux domaines, produit deux conclusions opposées sur le type numérique** |
